...
import com.paradise.common.uuid.handler.IdGeneratorManager;
import com.paradise.common.uuid.snowflake.Snowflake;
...
public final class SnowflakeIdUtil {
     ...
     * 雪花算法对象
     */
    private static Snowflake SNOWFLAKE = new Snowflake(0,0,true);
